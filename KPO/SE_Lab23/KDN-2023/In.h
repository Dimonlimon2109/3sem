...
#define IN_CODE_TABLE {\
	...
	IN::SPACE, IN::F, IN::DC, IN::F, IN::F, IN::F, IN::F, IN::SC, IN::SINGLE, IN::SINGLE, IN::SINGLE, IN::SINGLE, IN::SINGLE, IN::SINGLE, IN::SINGLE, IN::SINGLE,\
...
namespace In {
	...
	struct IN {
		enum {SC = 32, DC = 64, LINE = 128, SINGLE = 256, SPACE = 512, T = 1024, F = 2048, I = 4096};
		int size;
		int lines;
		int ignor;
		wchar_t* text;
