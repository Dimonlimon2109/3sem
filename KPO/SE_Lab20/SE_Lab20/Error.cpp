...
namespace Error {
	ERROR errors[ERROR_MAX_ENTRY] = {
		...
		ERROR_ENTRY(115, "LT: Превышен размер таблицы лексем"),
		ERROR_ENTRY(116, "IT: Превышен размер таблицы идентификаторов"),
		ERROR_ENTRY(117, "FST: Не удалось разобрать лексему из входного файла"),
		ERROR_ENTRY(118, "FST: Объявлен идентификатор без типа"),
		ERROR_ENTRY(119, "FST: Функция main объявлена более одного раза"),
		ERROR_ENTRY(120, "FST: Не объявлена функция main"),
		ERROR_ENTRY(121, "FST: Используется необъявленный идентификатор"),
		ERROR_ENTRY(122, "POLISHNOTATION: Не удалось выполнить преобразование в польскую запись"),//1
