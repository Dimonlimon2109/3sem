...
let user5cop = {...user5}
user5cop.studies = {...user5.studies}
user5cop.studies.department = {...user5.studies.department}
user5cop.studies.exams = [...user5.studies.exams]
user5cop.studies.exams[0] = {...user5.studies.exams[0]}
user5cop.studies.exams[1] = {...user5.studies.exams[1]}
console.log(user5);
let user6 = {
    name: 'Masha',
    age: 21,
